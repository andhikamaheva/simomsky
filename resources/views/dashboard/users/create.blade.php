 ...
 <div class="tab-pane active" id="tab_0">
  <div class="portlet box green">
   ...
   <div class="portlet-body form">
    <!-- BEGIN FORM-->
    <form action="{{URL('dashboard/users/')}}" method="post" class="form-horizontal">
     <input type="hidden" name="_token" value="{{csrf_token()}}"/>
     <div class="form-body">
      <div class="form-group">
       <label class="col-md-3 control-label">Username</label>
       <div class="col-md-4">
        <input type="text" class="form-control input-circle" name="username" placeholder="Masukkan Username">
       </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
       ...
       <div class="col-md-4">
        <div class="input-group">
         ...
         <input type="email" name="email" class="form-control input-circle-right" placeholder="Masukkan Alamat Email">
        </div>
       </div>
      </div>
      <div class="form-group">
       ...
       <div class="col-md-4">
        <input type="text" name="name" class="form-control input-circle" placeholder="Masukkan Nama Lengkap">
       </div>
      </div>
      <div class="form-group">
       <label class="col-md-3 control-label">Pekerjaan</label>
       <div class="col-md-4">
        <input type="text" name="work" class="form-control input-circle" placeholder="Masukkan Pekerjaan">
       </div>
      </div>
      <div class="form-group">
       <label class="col-md-3 control-label">Alamat</label>
       <div class="col-md-4">
        <input type="text" name="address" class="form-control input-circle" placeholder="Masukkan Alamat Lengkap">
       </div>
      </div>
      <div class="form-group last">
       <label class="col-md-3 control-label">No. Telp</label>
       <div class="col-md-4">
        <input type="text" name="phone" class="form-control input-circle" placeholder="Masukkan Nomor Telepon">
       </div>
      </div>
